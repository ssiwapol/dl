...
class LibriTrain(Dataset):
    ...
    def __init__(self, dir):
        ...
        # Set PHONEMES for mapping index
        self.PHONEMES = PHONEMES
        self.output_size = len(PHONEMES)
    ...
    def __getitem__(self, ind):
        ...
        # Map PHONEMES with index and exclude '<sos>' and '<eos>'
        Yy = np.array([self.PHONEMES.index(i) for i in Y[1:-1]])
