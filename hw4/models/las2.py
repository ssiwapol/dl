...
class Encoder(nn.Module):
    ...
    '''
    def __init__(self, input_dim, encoder_hidden_dim, device, 
        ...
        self.pBLSTMs = [
            pBLSTM(input_pblstm, encoder_hidden_dim, device, trunc),
            pBLSTM(input_pblstm, encoder_hidden_dim, device, trunc),
            pBLSTM(input_pblstm, encoder_hidden_dim, device, trunc)  
        ]
...
class Las02(nn.Module):
    def __init__(self, input_dim, vocab_size):
        super(Las02,self).__init__()

        # Model parameters
        encoder_hidden_dim=256
        encoder_lockdrop = 0.5
        encoder_dropout=0.2
...
class Las03(nn.Module):
    def __init__(self, input_dim, vocab_size):
        super(Las03,self).__init__()
